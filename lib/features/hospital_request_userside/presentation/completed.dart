        ...
        children: [
          Padding(
            ...
            child: SearchTextFieldButton(
              text: "Search Completed by phone number",
              controller: bookingProvider.searchCompletedBookingsController,
              onSubmit: (value) {
                bookingProvider.searchCompletedOrders(
            ...
            child: CustomScrollView(
              slivers: [
                if (bookingProvider.isLoading == true &&
                  ...
                  const SliverFillRemaining(
                    child:
                        NoDataImageWidget(text: 'No Completed Bookings Found'),
                  )
                else
                  SliverPadding(
                                    ...
                                    child: Column(
                                        ...
                                        children: [
                                          ...
                                          PatientDetailsContainer(
                                            ...
                                            patientGender:
                                                bookings.patientGender!,
                                            patientAge: bookings.patientAge!,
                                            patientPlace:
                                                bookings.patientPlace!,
                                            patientNumber:
                                                bookings.patientNumber!,
                                            onCall: () {
